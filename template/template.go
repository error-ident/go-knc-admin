...
import (
	...
	errors2 "github.com/error-ident/go-knc-admin/modules/errors"
	...
	"github.com/error-ident/go-knc-admin/template/login"
...
type Component interface {
	...
	//
	// See:
	// https://github.com/error-ident/go-knc-admin/blob/master/template/login/theme1.tmpl#L32
	// https://github.com/error-ident/go-knc-admin/blob/master/template/login/list.go
	GetAssetList() []string
