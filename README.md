...
[Comment the issue to tell us](https://github.com/error-ident/go-knc-admin/issues/71).
...
More framework examples: [https://github.com/error-ident/go-knc-admin/tree/master/examples](https://github.com/error-ident/go-knc-admin/tree/master/examples)
