...
在这里：[功能规划](https://github.com/error-ident/go-knc-admin/projects/3) 可以获得更多信息。
...
然后，你需要fork远程的master分支到你本地 **\$GOPATH**/src/go-knc-admin ：
...
注意了： `go get` 返回 `package go-knc-admin: no Go files in /go/src/go-knc-admin` 是正常的。
