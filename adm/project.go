...
func buildProject(cfgFile string) {
	...
	if defaultLang == "cn" || p.Language == language.CN || p.Language == "cn" {
		...
		fmt.Println("- sqlite: " + ansi.Color("https://github.com/error-ident/go-knc-admin/raw/master/data/admin.db", "blue"))
		fmt.Println("- mssql: " + ansi.Color("https://raw.githubusercontent.com/error-ident/github.com/error-ident/go-knc-admin/master/data/admin.mssql", "blue"))
		fmt.Println("- postgresql: " + ansi.Color("https://raw.githubusercontent.com/error-ident/github.com/error-ident/go-knc-admin/master/data/admin.pgsql", "blue"))
		fmt.Println("- mysql: " + ansi.Color("https://raw.githubusercontent.com/error-ident/github.com/error-ident/go-knc-admin/master/data/admin.sql", "blue"))
	}
	fmt.Println()
