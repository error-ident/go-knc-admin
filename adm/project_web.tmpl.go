...
> make serve</pre>
                            ...
                            <ul>
                                <li>
                                    <span style="font-size:15px;font-weight:normal;">Github：&nbsp;<a
                                                href="https://go-knc-admin" target="_blank">https://go-knc-admin</a></span>
                                </li>
                                <li>
                    ...
                    <div class="ui attached segment install-success-readme-en"
                        ...
                        <ul>
                            <li>
                                <a href="https://raw.githubusercontent.com/error-ident/github.com/error-ident/go-knc-admin/master/data/admin.sql"
                                   target="_blank">Mysql</a>
                            </li>
                            <li>
                                <a href="https://raw.githubusercontent.com/error-ident/github.com/error-ident/go-knc-admin/master/data/admin.mssql"
                                   target="_blank">Mssql</a>
                            </li>
                            <li>
                                <a href="https://raw.githubusercontent.com/error-ident/github.com/error-ident/go-knc-admin/master/data/admin.pgsql"
                                   target="_blank">Postgresql</a>
                            </li>
                            <li>
                                <a href="https://raw.githubusercontent.com/error-ident/github.com/error-ident/go-knc-admin/master/data/admin.db"
