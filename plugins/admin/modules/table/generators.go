...
import (
	...
	"github.com/error-ident/go-knc-admin/modules/db/dialect"
	errs "github.com/error-ident/go-knc-admin/modules/errors"
	"github.com/error-ident/go-knc-admin/modules/language"
	"github.com/error-ident/go-knc-admin/modules/logger"
	"github.com/error-ident/go-knc-admin/modules/ui"
	"github.com/error-ident/go-knc-admin/modules/utils"
	"github.com/error-ident/go-knc-admin/plugins/admin/models"
	form2 "github.com/error-ident/go-knc-admin/plugins/admin/modules/form"
	"github.com/error-ident/go-knc-admin/plugins/admin/modules/parameter"
	"github.com/error-ident/go-knc-admin/plugins/admin/modules/tools"
	...
	selection "github.com/error-ident/go-knc-admin/template/types/form/select"
...
func (s *SystemTable) GetGenerateForm(ctx *context.Context) (generateTool Table) {
	...
	formList.AddField(lgWithScore("extra import package", "tool"), "extra_import_package", db.Varchar, form.Select).
		FieldOptions(types.FieldOptions{
			...
			{Text: "log", Value: "log"},
			{Text: "fmt", Value: "fmt"},
			{Text: "github.com/error-ident/go-knc-admin/modules/db/dialect", Value: "github.com/error-ident/go-knc-admin/modules/db/dialect"},
			{Text: "github.com/error-ident/go-knc-admin/modules/db", Value: "github.com/error-ident/go-knc-admin/modules/db"},
			{Text: "github.com/error-ident/go-knc-admin/modules/language", Value: "github.com/error-ident/go-knc-admin/modules/language"},
			{Text: "github.com/error-ident/go-knc-admin/modules/logger", Value: "github.com/error-ident/go-knc-admin/modules/logger"},
		}).
		FieldDefault("").
